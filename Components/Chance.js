  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        />
        <Text style={{fontFamily: "MeriendaBold", ...styles.headerText}}>Probability</Text>
      </View>
      ...
      <TouchableOpacity style={styles.toggleBtn} onPress={() => setShowAll(!showAll)}>
        ...
        {
          !showAll && HourlyData.length > 5 ?<ChevronDownIcon size={28} color="#4fa3a9"/>:<ChevronUpIcon size={25} color="#4fa3a9"/>
        }
